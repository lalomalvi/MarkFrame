...
Los originales del logo de MarkFlow, de donde sale todo lo demás. **Aquí no se
edita nada**: si el logo cambia, llega uno nuevo y se vuelve a generar.

| Archivo | Qué es |
|---|---|
| `logo-markflow.ai` | El original de Illustrator. La fuente de verdad |
| `logo-markflow.svg` | Exportación vectorial, con los metadatos de Illustrator dentro |
| `logo-markflow.png` | 2726 × 2321, con el símbolo arriba y la palabra abajo |
...
La palabra «MarkFlow» **no entra en el icono**: a 16 píxeles es una mancha gris.
