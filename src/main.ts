import { crearPar, type Par } from './editor.ts'
import { refrescarPresentacion } from './livepreview.ts'
import { archivoInicial, escribir, huella, leer, pedirArchivo,
         pedirDestino } from './archivo.ts'
import { fijarCarpeta } from './contexto.ts'
import { olvidarPermisosSueltos, permitirRemotas } from './widgets.ts'
import * as prefs from './preferencias.ts'
import * as pest from './pestanas.ts'
import type { Pestana } from './pestanas.ts'
